...
const LongslipReport = ({ data }) => {
  const styles = {
    calibrationReport: {
      padding: '20px', margin: '0 auto', fontFamily: 'Arial, sans-serif', maxWidth: '800px', width: "210mm",
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            >
              <div style={{ display: "flex", borderBottom: "1px solid black",fontWeight:"bold", fontfamily: "Verdana, sans-serif",}}>
                ...
                <div style={{ padding: "5px" }}>22/53/01/041-S/2/140-B</div>
              </div>
  
              <div style={{ display: 'flex', justifyContent: 'space-between',fontWeight:"bold",fontfamily: "Verdana, sans-serif" }}>
                <div style={{ padding: '5px 10px', borderRight: '1px solid black', flex: 1}}>DATE: 07-09-2022</div>
                <div style={{ padding: '5px 10px', flex: 1 }}>Sheet: 1 of 2</div>
              </div>
              </div>
          </div>
