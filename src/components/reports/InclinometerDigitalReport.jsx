...
const InclinometerDigitalReport = ({ data }) => {
  return (
    <div>
      ...
      {/* Second Sheet */}
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto', fontFamily: 'Verdana, sans-serif', maxWidth: '800px', width: "210mm",
      ...
      <div style={{ width: "100%"  }}>
        ...
        <div style={{ display: "flex", alignItems: "center", marginTop: "150px" }}>
          ...
          >
            <div style={{ display: "flex", borderBottom: "1px solid black",fontWeight:"bold", fontfamily: "Arial, sans-serif",}}>
              <div style={{ padding: "5px", whiteSpace: "nowrap",fontfamily: "Verdana, sans-serif" }}>
                CERTIFICATE NUMBER:
              </div>
              <div style={{ padding: "5px",fontfamily: "Verdana, sans-serif" }}>21/53/01/041-5/3/218-J</div>
            </div>

            <div style={{ display: 'flex', justifyContent: 'space-between',fontWeight:"bold",fontfamily: "Verdana, sans-serif" }}>
              <div style={{ padding: '5px 10px', borderRight: '1px solid black', flex: 1 ,fontfamily: "Verdana, sans-serif",fontfamily: "Verdana, sans-serif"}}>DATE: 01-12-2021</div>
      ...
      <h3 style={{ marginTop: '20px' }}>I. Mechanical Calibration.</h3>

      {/* X-Axis Calibration Section */}
      <div>
        <h4>I. Calibration of X-Axis Scale: 
      ...
      <div>
        <h4>II. Calibration of Y-Axis Scale:</h4>
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
          <thead>
            <tr>
              <th rowSpan="2" style={{ border: '1px solid black' }}>Sl. No.</th>
