...
const InclinometerDigitalReport = ({ data }) => {
  return (
    <div>
      ...
      {/* Second Sheet */}
      <div style={{padding: '20px', margin: '0 auto', fontFamily: 'Verdana, sans-serif', maxWidth: '800px', width: "210mm",
        ...
        <div style={{ width: "100%"  }}>
          ...
          <div style={{ display: "flex", alignItems: "center", marginTop: "150px" }}>
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between',fontWeight:"bold" }}>
                <div style={{ padding: '5px 10px', borderRight: '1px solid black', flex: 1 ,fontfamily: "Verdana, sans-serif"}}>DATE: {data?.first_sheet?.report_issued_date}</div>
                <div style={{ padding: '5px 10px', flex: 1 }}>Sheet: 2 of 2</div>
              </div>
            </div>
          </div>
        </div>
