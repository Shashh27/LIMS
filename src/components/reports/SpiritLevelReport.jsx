          ...
          <div style={{ display: "flex", alignItems: "center", marginBottom: "10px" }}>
            ...
            >
              <div style={{ display: "flex", borderBottom: "1px solid black",fontWeight:"bold", fontfamily: "Verdana, sans-serif",}}>
                ...
                <div style={{ padding: "5px",fontfamily: "Verdana, sans-serif" }}>19/53/01/041-S/3/388-A</div>
              </div>
  
              <div style={{ display: 'flex', justifyContent: 'space-between',fontWeight:"bold",fontfamily: "Verdana, sans-serif" }}>
                <div style={{ padding: '5px 10px', borderRight: '1px solid black', flex: 1 ,fontfamily: "Verdana, sans-serif",fontfamily: "Verdana, sans-serif"}}>DATE: 20-03-2020</div>
