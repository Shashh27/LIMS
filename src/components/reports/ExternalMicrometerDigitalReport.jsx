...
const ExternalMicrometerDigitalReport = ({ data }) => {
  const styles = {
    calibrationReport: {
  ...
  return (
    ...
    <div style={{ width: "100%"  }}>
        ...
        <table style={styles.calibrationTable}>
          ...
          <tbody>
            {data?.micrometer_digital_thimble_calibrations?.map((item, index) => (
              <tr key={index}>
        ...
        <table style={styles.calibrationTable}>
          ...
          <tbody>
            {data?.digital_interchangeable_anvils_calibrations?.map((item, index) => (
              <tr key={index}>
                <td style={styles.tableCell}>{index + 1}.</td>
        ...
        <table style={styles.calibrationTable}>
          ...
          <tbody>
            {data?.digital_setting_gauge_rods_calibrations?.map((item, index) => (
              <tr key={index}>
                <td style={styles.tableCell}>{index + 1}.</td>
        ...
        <table style={styles.calibrationTable}>
          ...
          <tbody>
            {data?.digital_allowable_values_calibrations?.map((item, index) => (
              <>
                <tr key={`a${index}`}>
...
export default ExternalMicrometerDigitalReport;