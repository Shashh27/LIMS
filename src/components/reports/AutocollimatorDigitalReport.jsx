        ...
        <div style={{ display: "flex", alignItems: "center"}}>
          ...
          >
            <div style={{ display: "flex", borderBottom: "1px solid black",fontWeight:"bold" }}>
              ...
              <div style={{ padding: "5px" }}>ML/ACM-02/22.01/013</div>
            </div>

            <div style={{ display: 'flex', justifyContent: 'space-between',fontWeight:"bold" }}>
              <div style={{ padding: '5px 10px', borderRight: '1px solid black', flex: 1 }}>DATE: 27-01-2022</div>
              <div style={{ padding: '5px 10px', flex: 1 }}>Sheet: 1 of 4</div>
            </div>
            </div>
        </div>

        <div className="report-title" style={{marginTop:"50px"}}>
