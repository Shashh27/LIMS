          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            >
              <div style={{ display: "flex", borderBottom: "1px solid black",fontWeight:"bold", fontfamily: "Verdana, sans-serif",}}>
                ...
                <div style={{ padding: "5px",fontfamily: "Verdana, sans-serif" }}>ML/RTD-01/21.06/035</div>
              </div>
  
              <div style={{ display: 'flex', justifyContent: 'space-between',fontWeight:"bold",fontfamily: "Verdana, sans-serif" }}>
                <div style={{ padding: '5px 10px', borderRight: '1px solid black', flex: 1 ,fontfamily: "Verdana, sans-serif",fontfamily: "Verdana, sans-serif"}}>DATE: 30-06-2021</div>
