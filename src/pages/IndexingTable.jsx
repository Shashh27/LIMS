    ...
    try {
      ...
      const formData = {
        ...
        mechanical_calibrations: calibrationData
          .filter(item => item.normal_positioning && item.firstset_calibrated_cumulative_errors && 
                         item.secondset_calibrated_cumulative_errors && item.thirdset_calibrated_cumulative_errors)
          .map(item => ({
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/testing/indexing-table`,
        formData
      );
