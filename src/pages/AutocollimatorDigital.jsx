...
// CalibrationDetails Component - Extracted from the second file
...
// Main AutocollimatorDigital Component
  ...
  return (
    <Layout>
      ...
      <Content style={{ padding: '24px', background: '#f5f5f5', minHeight: '100vh' }}>
        {/* CalibrationDetails component inserted below the header and above the main content */}
        <CalibrationDetails />
