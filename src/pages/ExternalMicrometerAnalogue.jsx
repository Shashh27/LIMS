...
const ExternalMicrometerAnalogue = () => {
  ...
  return (
    <Layout>
      <Header style={{ 
        ...
        <Title level={4} style={{ margin: 0 }}>External Micrometer Analogue Calibration</Title>
      </Header>
      ...
      <Content style={{ padding: '24px', background: '#f5f5f5', minHeight: '100vh' }}>
        ...
        <Card style={{ width: "100%", padding: "20px", position: "relative", marginBottom: "24px" }}>
          ...
          {/* Bottom Section */}
          <Row gutter={[16, 16]} style={{ fontSize: "14px", marginTop: "20px" }}>
            <Col span={24}>
        ...
        {/* External Micrometer Analogue Component */}
        <Card>
...
export default ExternalMicrometerAnalogue;